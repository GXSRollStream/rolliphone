module AddressBook
  class Person
    ...
    def save
      ...
      ABGroupAddMember(address_group, ab_person, error)
      ABAddressBookAddRecord(address_book, address_group, error)
      ABAddressBookSave(address_book, error)
      @address_book = nil #force refresh
      @address_group = nil #force refresh
      @new_record = false
    end

    def address_group
      @address_group ||= (load_group || create_group) 
    end
